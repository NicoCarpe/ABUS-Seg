...
nnUNetv2_train "$2" nnUNetTrainerV2_Loss_DiceTopK10Focal  "$1" "$3" --npz ## Use this to start training from scratch
# nnUNetv2_train --c "$2" nnUNetTrainerV2_Loss_DiceTopK10Focal "$1" "$3" --npz ##Use this to continue training 